...
public class DragGridView extends GridView implements AdapterView.OnItemLongClickListener {
    ...
    private void initWindow() {
        if (dragView == null) {
            ...
            TextView tv_text = dragView.findViewById(R.id.tv_text);
    ...
    Animation.AnimationListener animationListener = new Animation.AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (adapter != null && adapter instanceof AddMyTabItemGVAdapter) {
//                ((AddMyTabItemGVAdapter) adapter).exchangePosition(position, tempPosition, true);
            }
    ...
    private void itemDrop() {
        if (tempPosition == position || tempPosition == GridView.INVALID_POSITION) {
            ...
            ListAdapter adapter = getAdapter();
            if (adapter != null && adapter instanceof AddMyTabItemGVAdapter) {
//                ((AddMyTabItemGVAdapter) adapter).exchangePosition(position, tempPosition, false);
            }
        }
    }
