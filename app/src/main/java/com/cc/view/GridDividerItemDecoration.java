...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State
        ...
        System.out.println("++++++++++++++条目，" + parent.getChildLayoutPosition(view) + "是否最后一行" + isLastRow(parent.getChildLayoutPosition(view), parent));
        System.out.println("++++++++++++++条目，" + parent.getChildLayoutPosition(view) + "是否最后一列" + isLastColum(parent.getChildLayoutPosition(view), parent));
